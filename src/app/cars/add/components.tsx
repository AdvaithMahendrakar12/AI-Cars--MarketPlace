...
import { addCarSchema, AddCarSchema, ImageSchema, ImageSchemaType } from "@/lib/zod";
import { addNewCar, generateImage } from "@/lib/actions/carActions";
...
import { CarFuelType, CarType, carTypes } from "../../../constants/car";
import { autoGenerateCar } from "@/lib/actions/aiAction";
...
export const GenerateImage = () => {    
  ...
  const onSubmit = async ({ description, name }: ImageSchemaType) => {
...
const STORAGE_KEY = "car-form-data";
export const AddCarForm = () => {

   const { images, removeImage, addImage, clearImages } = useImageStore();
